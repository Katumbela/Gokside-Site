...
Put the required stylesheet at the [top](https://developer.yahoo.com/performance/rules.php#css_top) of your markup:
...
Put the script at the [bottom](https://developer.yahoo.com/performance/rules.php#js_bottom) of your markup right after jQuery:
